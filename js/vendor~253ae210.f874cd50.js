 ...
 * limitations under the License.
 */
class Uo{constructor(t,e){this.hasPendingWrites=t,this.fromCache=e}isEqual(t){return this.hasPendingWrites===t.hasPendingWrites&&this.fromCache===t.fromCache}}class Vo extends wo{constructor(t,e,n,r,i,s){super(t,e,n,r,s),this._firestore=t,this._firestoreImpl=t,this.metadata=i}exists(){return super.exists()}data(t={}){if(this._document){if(this._converter){const e=new Fo(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(e,t)}return this._userDataWriter.convertValue(this._document.data.value,t.serverTimestamps)}}get(t,e={}){if(this._document){const n=this._document.data.field(Eo("DocumentSnapshot.get",t));if(null!==n)return this._userDataWriter.convertValue(n,e.serverTimestamps)}}}class Fo extends Vo{data(t={}){return super.data(t)}}class jo{constructor(t,e,n,r){this._firestore=t,this._userDataWriter=e,this._snapshot=r,this.metadata=new Uo(r.hasPendingWrites,r.fromCache),this.query=n}get docs(){const t=[];return this.forEach(e=>t.push(e)),t}get size(){return this._snapshot.docs.size}get empty(){return 0===this.size}forEach(t,e){this._snapshot.docs.forEach(n=>{t.call(e,new Fo(this._firestore,this._userDataWriter,n.key,n,new Uo(this._snapshot.mutatedKeys.has(n.key),this._snapshot.fromCache),this.query.converter))})}docChanges(t={}){const e=!!t.includeMetadataChanges;if(e&&this._snapshot.excludesMetadataChanges)throw new E(b.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===e||(this._cachedChanges=function(t,e){if(t._snapshot.oldDocs.isEmpty()){let e=0;return t._snapshot.docChanges.map(n=>({type:"added",doc:new Fo(t._firestore,t._userDataWriter,n.doc.key,n.doc,new Uo(t._snapshot.mutatedKeys.has(n.doc.key),t._snapshot.fromCache),t.query.converter),oldIndex:-1,newIndex:e++}))}{let n=t._snapshot.oldDocs;return t._snapshot.docChanges.filter(t=>e||3!==t.type).map(e=>{const r=new Fo(t._firestore,t._userDataWriter,e.doc.key,e.doc,new Uo(t._snapshot.mutatedKeys.has(e.doc.key),t._snapshot.fromCache),t.query.converter);let i=-1,s=-1;return 0!==e.type&&(i=n.indexOf(e.doc.key),n=n.delete(e.doc.key)),1!==e.type&&(n=n.add(e.doc),s=n.indexOf(e.doc.key)),{type:$o(e.type),doc:r,oldIndex:i,newIndex:s}})}}(this,e),this._cachedChangesIncludeMetadataChanges=e),this._cachedChanges}}function $o(t){switch(t){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return y()}}class Bo extends xo{constructor(t){super(),this.firestore=t}convertBytes(t){return new Ks(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new As(this.firestore,null,e)}}function qo(t){t=Is(t,Cs);const e=Is(t.firestore,Bs),n=Hs(e),r=new Bo(e);return Io(t._query),js(n,t._query).then(n=>new jo(e,r,t,n))}function Ho(t,e,n,...r){t=Is(t,As);const i=Is(t.firestore,Bs),s=no(i);let a;return a="string"==typeof(e=Object(o.n)(e))||e instanceof Gs?ao(s,"updateDoc",t._key,e,n,r):oo(s,"updateDoc",t._key,e),Go(i,[a.toMutation(t._key,Ue.exists(!0))])}function zo(t){return Go(Is(t.firestore,Bs),[new Ye(t._key,Ue.none())])}function Ko(t,e){const n=Is(t.firestore,Bs),r=Ns(t),i=Po(t.converter,e);return Go(n,[ro(no(t.firestore),"addDoc",r._key,i,null!==t.converter,{}).toMutation(r._key,Ue.exists(!1))]).then(()=>r)}function Go(t,e){return function(t,e){const n=new I;return t.asyncQueue.enqueueAndForget(async()=>async function(t,e,n){const r=ms(t);try{const t=await function(t,e){const n=w(t),r=x.now(),i=e.reduce((t,e)=>t.add(e.key),mn());let s,o;return n.persistence.runTransaction("Locally write mutations","readwrite",t=>{let a=on(),c=mn();return n.Gi.getEntries(t,i).next(t=>{a=t,a.forEach((t,e)=>{e.isValidDocument()||(c=c.add(t))})}).next(()=>n.localDocuments.getOverlayedDocuments(t,a)).next(i=>{s=i;const o=[];for(const t of e){const e=qe(t,s.get(t.key).overlayedDocument);null!=e&&o.push(new Ke(t.key,e,Pt(e.value.mapValue),Ue.exists(!0)))}return n.mutationQueue.addMutationBatch(t,r,o,e)}).next(e=>{o=e;const r=e.applyToLocalDocumentSet(s,c);return n.documentOverlayCache.saveOverlays(t,e.batchId,r)})}).then(()=>({batchId:o.batchId,changes:un(s)}))}(r.localStore,e);r.sharedClientState.addPendingMutation(t.batchId),function(t,e,n){let r=t.hc[t.currentUser.toKey()];r||(r=new nt(L)),r=r.insert(e,n),t.hc[t.currentUser.toKey()]=r}(r,t.batchId,n),await ls(r,t.changes),await vi(r.remoteStore)}catch(t){const e=Ri(t,"Failed to persist write");n.reject(e)}}(await Vs(t),e,n)),n.promise}(Hs(t),e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Xo(t){return Hs(t=Is(t,Bs)),new Wo(t,e=>Go(t,e))
/**
 * @license
 * Copyright 2021 Google LLC
 *
